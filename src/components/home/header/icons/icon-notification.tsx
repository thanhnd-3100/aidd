...
/**
 * mm_media_noti (single-color icon) — fill swapped for currentColor per
 * code-rules.md rule 2a. The unread badge dot is intentionally not part of
 * this icon: per clarifications.md, the badge is always hidden (no
 * unread-count logic).
 */
