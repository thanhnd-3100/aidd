...
/**
 * SAA event mark — Figma group I5022:15169;214:3839;186:1766;214:3762
 * ("MM_MEDIA_Kudos Logo"). Multi-color icon (brand red/gradient) — kept as
 * the original palette per code-rules.md §2a, not converted to currentColor.
 */
export function IconSaa(props: SVGProps<SVGSVGElement>) {
  return (
