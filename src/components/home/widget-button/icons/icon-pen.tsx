...
/**
 * Pen icon — Figma instance I5022:15169;214:3839;186:1763 (mms_6_Widget
 * Button's "MM_MEDIA_Pen"). Mono icon: fill swapped to currentColor per
 * code-rules.md §2a so the parent's `color` controls it via CSS.
 */
